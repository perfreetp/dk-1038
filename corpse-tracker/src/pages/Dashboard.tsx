...
import { industryLabels, statusLabels } from '../data/mockData';

const COLORS = ['#d4a574', '#1a2332', '#28a745', '#dc3545', '#007bff'];

export function Dashboard() {
  const { state } = useApp();
  const { stats, leads } = state;
    ...
    <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-accent to-accent-dark p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold mt-2">{stats.weeklyNew}</p>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold mt-2">{stats.pendingVerification}</p>
        ...
        <Card>
          ...
          <CardBody>
            <div className="space-y-4">
              {stats.sourceQuality.map((item, index) => (
                <div key={item.source}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardBody>
            <ResponsiveContainer width="100%" height={280}>
              <BarChart data={stats.editorProgress} layout="vertical">
                <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
                <XAxis type="number" />
